...
import { routeConfiguringFunction, AppiumDriver } from './driver';
...
class AppiumBuilder {
  ...
  constructor (args) {
    //this.appium = new AppiumDriver(args);
  ...
  async run (args = null) {
    ...
    for (let [name, driver] of _.toPairs(this.automations)) {
      appiumDriver.addAutomationDriver(name, driver);
    }
